...
# Tim tac gia trong muc tim kiem nang cao (o trong menu)
...
# Chon duong dan tac gia trong muc dau tien
...
for each in items:
    try:
        ...
        # Lay ten tac gia va mo ta bai bao
...
df1.to_csv(dir_name + "/" + name + ".csv", index_label="No.")
sleep(2)
browser.close()
